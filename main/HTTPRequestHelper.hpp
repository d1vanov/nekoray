...
namespace NekoGui_network {
    ...
    public:
        [[nodiscard]] static NekoHTTPResponse HttpGet(const QUrl &url);

        [[nodiscard]] static QString GetHeader(const QList<QPair<QByteArray, QByteArray>> &header, const QString &name);
    };
} // namespace NekoGui_network
